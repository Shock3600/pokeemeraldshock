...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_1, TRAINER_ROSE_1, TRAINER_ROSE_1, TRAINER_ROSE_1, TRAINER_ROSE_1, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY_1, TRAINER_DUSTY_1, TRAINER_DUSTY_1, TRAINER_DUSTY_1, TRAINER_DUSTY_1, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_RICKY_1, TRAINER_RICKY_1, TRAINER_RICKY_1, TRAINER_RICKY_1, ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_1, ROUTE124),
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, ROUTE121),
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE_1, TRAINER_BROOKE_1, TRAINER_BROOKE_1, TRAINER_BROOKE_1, TRAINER_BROOKE_1, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_WILTON_1, TRAINER_WILTON_1, TRAINER_WILTON_1, TRAINER_WILTON_1, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY_1, TRAINER_CINDY_1, TRAINER_CINDY_1, TRAINER_CINDY_1, TRAINER_CINDY_1, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_THALIA_1, TRAINER_THALIA_1, TRAINER_THALIA_1, TRAINER_THALIA_1, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, TRAINER_JESSICA_1, TRAINER_JESSICA_1, TRAINER_JESSICA_1, TRAINER_JESSICA_1, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, TRAINER_STEVE_1, TRAINER_STEVE_1, TRAINER_STEVE_1, TRAINER_STEVE_1, ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_TONY_1, TRAINER_TONY_1, TRAINER_TONY_1, TRAINER_TONY_1, TRAINER_TONY_1, ROUTE107),
    [REMATCH_NOB] = REMATCH(TRAINER_NOB_1, TRAINER_NOB_1, TRAINER_NOB_1, TRAINER_NOB_1, TRAINER_NOB_1, ROUTE115),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, ROUTE123),
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON_1, TRAINER_DALTON_1, TRAINER_DALTON_1, TRAINER_DALTON_1, TRAINER_DALTON_1, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, TRAINER_BERNIE_1, TRAINER_BERNIE_1, TRAINER_BERNIE_1, TRAINER_BERNIE_1, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, TRAINER_ETHAN_1, TRAINER_ETHAN_1, TRAINER_ETHAN_1, TRAINER_ETHAN_1, JAGGED_PASS),
    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_1, METEOR_FALLS_1F_1R),
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY_1, TRAINER_JEFFREY_1, TRAINER_JEFFREY_1, TRAINER_JEFFREY_1, TRAINER_JEFFREY_1, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON_1, TRAINER_CAMERON_1, TRAINER_CAMERON_1, TRAINER_CAMERON_1, TRAINER_CAMERON_1, ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_JACKI_1, TRAINER_JACKI_1, TRAINER_JACKI_1, TRAINER_JACKI_1, TRAINER_JACKI_1, ROUTE123),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER_1, TRAINER_WALTER_1, TRAINER_WALTER_1, TRAINER_WALTER_1, TRAINER_WALTER_1, ROUTE121),
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, TRAINER_KAREN_1, TRAINER_KAREN_1, TRAINER_KAREN_1, TRAINER_KAREN_1, ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_JERRY_1, TRAINER_JERRY_1, TRAINER_JERRY_1, TRAINER_JERRY_1, ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_1, ROUTE117),
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_1, TRAINER_ISABEL_1, TRAINER_ISABEL_1, TRAINER_ISABEL_1, ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_MIGUEL_1, TRAINER_MIGUEL_1, TRAINER_MIGUEL_1, TRAINER_MIGUEL_1, ROUTE103),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY_1, TRAINER_SHELBY_1, TRAINER_SHELBY_1, TRAINER_SHELBY_1, TRAINER_SHELBY_1, MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_1, TRAINER_ELLIOT_1, TRAINER_ELLIOT_1, TRAINER_ELLIOT_1, TRAINER_ELLIOT_1, ROUTE106),
    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH_1, TRAINER_ISAIAH_1, TRAINER_ISAIAH_1, TRAINER_ISAIAH_1, TRAINER_ISAIAH_1, ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_MARIA_1, TRAINER_MARIA_1, TRAINER_MARIA_1, TRAINER_MARIA_1, ROUTE117),
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_1, ROUTE110),
    [REMATCH_DYLAN] = REMATCH(TRAINER_DYLAN_1, TRAINER_DYLAN_1, TRAINER_DYLAN_1, TRAINER_DYLAN_1, TRAINER_DYLAN_1, ROUTE117),
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, TRAINER_KATELYN_1, TRAINER_KATELYN_1, TRAINER_KATELYN_1, TRAINER_KATELYN_1, ROUTE128),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_1, ROUTE110),
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, ROUTE126),
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS_1, TRAINER_NICOLAS_1, TRAINER_NICOLAS_1, TRAINER_NICOLAS_1, TRAINER_NICOLAS_1, METEOR_FALLS_1F_1R),
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, TRAINER_ROBERT_1, TRAINER_ROBERT_1, TRAINER_ROBERT_1, TRAINER_ROBERT_1, ROUTE120),
    [REMATCH_LAO] = REMATCH(TRAINER_LAO_1, TRAINER_LAO_1, TRAINER_LAO_1, TRAINER_LAO_1, TRAINER_LAO_1, ROUTE113),
    [REMATCH_CYNDY] = REMATCH(TRAINER_CYNDY_1, TRAINER_CYNDY_1, TRAINER_CYNDY_1, TRAINER_CYNDY_1, TRAINER_CYNDY_1, ROUTE115),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE_1, TRAINER_MADELINE_1, TRAINER_MADELINE_1, TRAINER_MADELINE_1, TRAINER_MADELINE_1, ROUTE113),
    [REMATCH_JENNY] = REMATCH(TRAINER_JENNY_1, TRAINER_JENNY_1, TRAINER_JENNY_1, TRAINER_JENNY_1, TRAINER_JENNY_1, ROUTE124),
    [REMATCH_DIANA] = REMATCH(TRAINER_DIANA_1, TRAINER_DIANA_1, TRAINER_DIANA_1, TRAINER_DIANA_1, TRAINER_DIANA_1, JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_1, ROUTE103),
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_1, TRAINER_ERNEST_1, TRAINER_ERNEST_1, TRAINER_ERNEST_1, TRAINER_ERNEST_1, ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, ROUTE108),
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_EDWIN_1, TRAINER_EDWIN_1, TRAINER_EDWIN_1, TRAINER_EDWIN_1, ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_LYDIA_1, TRAINER_LYDIA_1, TRAINER_LYDIA_1, TRAINER_LYDIA_1, ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, TRAINER_ISAAC_1, TRAINER_ISAAC_1, TRAINER_ISAAC_1, TRAINER_ISAAC_1, ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_1, MT_PYRE_1F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE_1, TRAINER_CATHERINE_1, TRAINER_CATHERINE_1, TRAINER_CATHERINE_1, TRAINER_CATHERINE_1, ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON_1, TRAINER_JACKSON_1, TRAINER_JACKSON_1, TRAINER_JACKSON_1, TRAINER_JACKSON_1, ROUTE119),
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_HALEY_1, TRAINER_HALEY_1, TRAINER_HALEY_1, TRAINER_HALEY_1, ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES_1, TRAINER_JAMES_1, TRAINER_JAMES_1, TRAINER_JAMES_1, TRAINER_JAMES_1, PETALBURG_WOODS),
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_1, TRAINER_TRENT_1, TRAINER_TRENT_1, TRAINER_TRENT_1, TRAINER_TRENT_1, ROUTE112),
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, MT_CHIMNEY),
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_1, ABANDONED_SHIP_ROOMS2_1F),
