...
#define FLAG_MEGA_BRACELET_GET               0x54  // Mega bracelet flag used by Shock
#define FLAG_BIRCH_STONE_GET                 0x55  // Gotten megastone from Birch
...
#define FLAG_ITEM_SKYPILLAR_ENTRANCE_DRAGON_SCALE                   0x479 // Shock dragon scale sky pillar
